define(['lodash', 'async', 'core/delegator', 'core/eventifier', 'core/providerRegistry', 'core/tokenHandler', 'core/connectivity'], function (_, async, delegator, eventifier, providerRegistry, tokenHandlerFactory, connectivity) { 'use strict';
    ...
    connectivity = connectivity && connectivity.hasOwnProperty('default') ? connectivity['default'] : connectivity;
