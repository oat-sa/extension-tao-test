define("taoTests/runner/areaBroker",["lodash","core/areaBroker"],function(_,areaBroker){"use strict";return _.partial(areaBroker,["content","toolbox","navigation","control","header","panel"])}),define("taoTests/runner/dataHolder",["core/collections"],function(collections){"use strict";var defaultObjects=["testData","testContext","testMap"];return function(){var map=new collections.Map;return defaultObjects.forEach(function(entry){map.set(entry,{})}),map}}),define("taoTests/runner/plugin",["lodash","core/plugin"],function(_,pluginFactory){"use strict";return _.partialRight(pluginFactory,{hostName:"testRunner"})}),function(a,b){"use strict"
;"function"==typeof define&&define.amd?define("lib/moment-timezone.min",["moment"],b):"object"==typeof module&&module.exports?module.exports=b(require("moment")):b(a.moment)}(this,function(a){"use strict";function b(a){return 96<a?a-87:64<a?a-29:a-48}function c(a){var d=0,e=a.split("."),f=e[0],g=e[1]||"",h=1,i=0,j=1;for(45===a.charCodeAt(0)&&(j=-(d=1));d<f.length;d++)i=60*i+b(f.charCodeAt(d));for(d=0;d<g.length;d++)h/=60,i+=b(g.charCodeAt(d))*h;return i*j}function d(a){for(var b=0;b<a.length;b++)a[b]=c(a[b])}function f(a,b){var c,d=[];for(c=0;c<b.length;c++)d[c]=a[b[c]];return d}function g(a){var b=a.split("|"),c=b[2].split(" "),g=b[3].split(""),
h=b[4].split(" ");return d(c),d(g),d(h),function(a,b){for(var c=0;c<b;c++)a[c]=Math.round((a[c-1]||0)+6e4*a[c]);a[b-1]=1/0}(h,g.length),{name:b[0],abbrs:f(b[1].split(" "),g),offsets:f(c,g),untils:h,population:0|b[5]}}function h(a){a&&this._set(g(a))}function i(a){var b=a.toTimeString(),c=b.match(/\([a-z ]+\)/i);"GMT"===(c=c&&c[0]?(c=c[0].match(/[A-Z]/g))?c.join(""):void 0:(c=b.match(/[A-Z]{3,5}/g))?c[0]:void 0)&&(c=void 0),this.at=+a,this.abbr=c,this.offset=a.getTimezoneOffset()}function j(a){this.zone=a,this.offsetScore=0,this.abbrScore=0}function k(a,b){for(var c,d;d=6e4*((b.at-a.at)/12e4|0);)(c=new i(new Date(a.at+d))).offset===a.offset?a=c:b=c;return a}
function l(){var a,b,c,d=(new Date).getFullYear()-2,e=new i(new Date(d,0,1)),f=[e];for(c=1;c<48;c++)(b=new i(new Date(d,c,1))).offset!==e.offset&&(a=k(e,b),f.push(a),f.push(new i(new Date(a.at+6e4)))),e=b;for(c=0;c<4;c++)f.push(new i(new Date(d+c,0,1))),f.push(new i(new Date(d+c,6,1)));return f}function m(a,b){return a.offsetScore!==b.offsetScore?a.offsetScore-b.offsetScore:a.abbrScore!==b.abbrScore?a.abbrScore-b.abbrScore:b.zone.population-a.zone.population}function n(a,b){var c,e;for(d(b),c=0;c<b.length;c++)e=b[c],I[e]=I[e]||{},I[e][a]=!0}function p(){try{var a=Intl.DateTimeFormat().resolvedOptions().timeZone;if(a){var b=H[r(a)];if(b)return b;z(
"Moment Timezone found "+a+" from the Intl api, but did not have that data loaded.")}}catch(c){}var d,e,f,g=l(),h=g.length,i=function(a){var b,c,d,e=a.length,f={},g=[];for(b=0;b<e;b++)for(c in d=I[a[b].offset]||{})d.hasOwnProperty(c)&&(f[c]=!0);for(b in f)f.hasOwnProperty(b)&&g.push(H[b]);return g}(g),k=[];for(e=0;e<i.length;e++){for(d=new j(t(i[e]),h),f=0;f<h;f++)d.scoreOffsetAt(g[f]);k.push(d)}return k.sort(m),0<k.length?k[0].zone.name:void 0}function r(a){return(a||"").toLowerCase().replace(/\//g,"_")}function s(a){var b,c,d,e;for("string"==typeof a&&(a=[a]),b=0;b<a.length;b++)e=r(c=(d=a[b].split("|"))[0]),F[e]=a[b],H[e]=c,d[5]&&n(e,d[2].split(" "))}
function t(a,b){a=r(a);var c,d=F[a];return d instanceof h?d:"string"==typeof d?(d=new h(d),F[a]=d):G[a]&&b!==t&&(c=t(G[a],t))?((d=F[a]=new h)._set(c),d.name=H[a],d):null}function v(a){var b,c,d,e;for("string"==typeof a&&(a=[a]),b=0;b<a.length;b++)d=r((c=a[b].split("|"))[0]),e=r(c[1]),G[d]=e,H[d]=c[0],G[e]=d,H[e]=c[1]}function w(a){s(a.zones),v(a.links),A.dataVersion=a.version}function y(a){return!(!a._a||void 0!==a._tzm)}function z(a){"undefined"!=typeof console&&"function"==typeof console.error&&console.error(a)}function A(b){var c=Array.prototype.slice.call(arguments,0,-1),d=arguments[arguments.length-1],e=t(d),f=a.utc.apply(null,c);return e&&!a.isMoment(b
)&&y(f)&&f.add(e.parse(f),"minutes"),f.tz(d),f}function B(a){return function(){return this._z?this._z.abbr(this):a.call(this)}}if(void 0!==a.tz)return z("Moment Timezone "+a.tz.version+" was already loaded "+(a.tz.dataVersion?"with data from ":"without any data")+a.tz.dataVersion),a;var D,F={},G={},H={},I={},J=a.version.split("."),K=+J[0],L=+J[1];(K<2||2===K&&L<6)&&z("Moment Timezone requires Moment.js >= 2.6.0. You are using Moment.js "+a.version+". See momentjs.com"),h.prototype={_set:function(a){this.name=a.name,this.abbrs=a.abbrs,this.untils=a.untils,this.offsets=a.offsets,this.population=a.population},_index:function(a){var b,c=+a,d=this.untils;for(
b=0;b<d.length;b++)if(c<d[b])return b},parse:function(a){var b,c,d,e,f=+a,g=this.offsets,h=this.untils,i=h.length-1;for(e=0;e<i;e++)if(b=g[e],c=g[e+1],d=g[e?e-1:e],b<c&&A.moveAmbiguousForward?b=c:d<b&&A.moveInvalidForward&&(b=d),f<h[e]-6e4*b)return g[e];return g[i]},abbr:function(a){return this.abbrs[this._index(a)]},offset:function(a){return this.offsets[this._index(a)]}},j.prototype.scoreOffsetAt=function(a){this.offsetScore+=Math.abs(this.zone.offset(a.at)-a.offset),this.zone.abbr(a.at).replace(/[^A-Z]/g,"")!==a.abbr&&this.abbrScore++},A.version="0.5.10",A.dataVersion="",A._zones=F,A._links=G,A._names=H,A.add=s,A.link=v,A.load=w,A.zone=t,
A.zoneExists=function x(a){return x.didShowError||(x.didShowError=!0,z("moment.tz.zoneExists('"+a+"') has been deprecated in favor of !moment.tz.zone('"+a+"')")),!!t(a)},A.guess=function(a){return D&&!a||(D=p()),D},A.names=function(){var a,b=[];for(a in H)H.hasOwnProperty(a)&&(F[a]||F[G[a]])&&H[a]&&b.push(H[a]);return b.sort()},A.Zone=h,A.unpack=g,A.unpackBase60=c,A.needsOffset=y,A.moveInvalidForward=!0,A.moveAmbiguousForward=!1;var M=a.fn;a.tz=A,a.defaultZone=null,a.updateOffset=function(b,c){var d,e=a.defaultZone;void 0===b._z&&(e&&y(b)&&!b._isUTC&&(b._d=a.utc(b._a)._d,b.utc().add(e.parse(b),"minutes")),b._z=e),b._z&&(d=b._z.offset(b),Math.abs(d)<16&&(
d/=60),void 0!==b.utcOffset?b.utcOffset(-d,c):b.zone(d,c))},M.tz=function(b){return b?(this._z=t(b),this._z?a.updateOffset(this):z("Moment Timezone has no data for "+b+". See http://momentjs.com/timezone/docs/#/data-loading/."),this):this._z?this._z.name:void 0},M.zoneName=B(M.zoneName),M.zoneAbbr=B(M.zoneAbbr),M.utc=function(a){return function(){return this._z=null,a.apply(this,arguments)}}(M.utc),a.tz.setDefault=function(b){return(K<2||2===K&&L<9)&&z("Moment Timezone setDefault() requires Moment.js >= 2.9.0. You are using Moment.js "+a.version+"."),a.defaultZone=b?t(b):null,a};var N=a.momentProperties
;return"[object Array]"===Object.prototype.toString.call(N)?(N.push("_z"),N.push("_a")):N&&(N._z=null),w({version:"2016j",zones:["Africa/Abidjan|LMT GMT|g.8 0|01|-2ldXH.Q|48e5","Africa/Accra|LMT GMT GHST|.Q 0 -k|012121212121212121212121212121212121212121212121|-26BbX.8 6tzX.8 MnE 1BAk MnE 1BAk MnE 1BAk MnE 1C0k MnE 1BAk MnE 1BAk MnE 1BAk MnE 1C0k MnE 1BAk MnE 1BAk MnE 1BAk MnE 1C0k MnE 1BAk MnE 1BAk MnE 1BAk MnE 1C0k MnE 1BAk MnE 1BAk MnE 1BAk MnE 1C0k MnE 1BAk MnE 1BAk MnE|41e5","Africa/Nairobi|LMT EAT BEAT BEAUT|-2r.g -30 -2u -2J|01231|-1F3Cr.g 3Dzr.g okMu MFXJ|47e5",
"Africa/Algiers|PMT WET WEST CET CEST|-9.l 0 -10 -10 -20|0121212121212121343431312123431213|-2nco9.l cNb9.l HA0 19A0 1iM0 11c0 1oo0 Wo0 1rc0 QM0 1EM0 UM0 DA0 Imo0 rd0 De0 9Xz0 1fb0 1ap0 16K0 2yo0 mEp0 hwL0 jxA0 11A0 dDd0 17b0 11B0 1cN0 2Dy0 1cN0 1fB0 1cL0|26e5","Africa/Lagos|LMT WAT|-d.A -10|01|-22y0d.A|17e6","Africa/Bissau|LMT WAT GMT|12.k 10 0|012|-2ldWV.E 2xonV.E|39e4","Africa/Maputo|LMT CAT|-2a.k -20|01|-2GJea.k|26e5",
...
"Pacific/Pago_Pago|Pacific/Midway","Pacific/Pago_Pago|Pacific/Samoa","Pacific/Pago_Pago|US/Samoa","Pacific/Pohnpei|Pacific/Ponape"]}),a}),define("taoTests/runner/probeOverseer",["lodash","core/promise","moment","lib/uuid","lib/moment-timezone.min"],function(_,Promise,moment,uuid){"use strict";var timeZone=moment.tz.guess(),slice=Array.prototype.slice;return function(runner){var overseer,queueStorage,probes=[],queue=[],immutableQueue=[],writing=Promise.resolve(),started=!1,getStorage=function(){return queueStorage?Promise.resolve(queueStorage):runner.getTestStore().getStore("test-probe").then(function(newStorage){return queueStorage=newStorage,
Promise.resolve(queueStorage)})},resetStorage=function(){queueStorage=null};function collectEvent(probe){var eventNs=".probe-"+probe.name,probeHandler=function(){var now=moment(),data={id:uuid(12,16),type:probe.name,timestamp:now.format("x")/1e3,timezone:now.tz(timeZone).format("Z")};"function"==typeof probe.capture&&(data.context=probe.capture.apply(probe,[runner].concat(slice.call(arguments)))),overseer.push(data)};if(probe.latency)return collectLatencyEvent(probe);_.forEach(probe.events,function(eventName){var listen=0<eventName.indexOf(".")?eventName:eventName+eventNs;runner.on(listen,_.partial(probeHandler,eventName))})}function collectLatencyEvent(
probe){var eventNs=".probe-"+probe.name,startHandler=function(){var now=moment(),data={id:uuid(12,16),marker:"start",type:probe.name,timestamp:now.format("x")/1e3,timezone:now.tz(timeZone).format("Z")};"function"==typeof probe.capture&&(data.context=probe.capture.apply(probe,[runner].concat(slice.call(arguments)))),overseer.push(data)},stopHandler=function(){var last,now=moment(),data={type:probe.name,timestamp:now.format("x")/1e3,timezone:now.tz(timeZone).format("Z")},args=slice.call(arguments);(last=_.findLast(immutableQueue,{type:probe.name,marker:"start"}))&&!_.findLast(immutableQueue,{type:probe.name,marker:"end",id:last.id})&&(data.id=last.id,
data.marker="end","function"==typeof probe.capture&&(data.context=probe.capture.apply(probe,[runner].concat(args))),overseer.push(data))};if(!probe.latency)return collectEvent(probe);_.forEach(probe.startEvents,function(eventName){var listen=0<eventName.indexOf(".")?eventName:eventName+eventNs;runner.on(listen,_.partial(startHandler,eventName))}),_.forEach(probe.stopEvents,function(eventName){var listen=0<eventName.indexOf(".")?eventName:eventName+eventNs;runner.on(listen,_.partial(stopHandler,eventName))})}if(!_.isPlainObject(runner)||!_.isFunction(runner.init)||!_.isFunction(runner.on))throw new TypeError("Please set a test runner");return overseer={
add:function(probe){if(!_.isPlainObject(probe))throw new TypeError("A probe is a plain object");if(!_.isString(probe.name)||_.isEmpty(probe.name))throw new TypeError("A probe must have a name");if(0<_.where(probes,{name:probe.name}).length)throw new TypeError("A probe with this name is already regsitered");if(probe.latency){if(_.isString(probe.startEvents)&&!_.isEmpty(probe.startEvents)&&(probe.startEvents=[probe.startEvents]),_.isString(probe.stopEvents)&&!_.isEmpty(probe.stopEvents)&&(probe.stopEvents=[probe.stopEvents]),!probe.startEvents.length||!probe.stopEvents.length)throw new TypeError(
"Latency based probes must have startEvents and stopEvents defined");started&&collectLatencyEvent(probe)}else{if(_.isString(probe.events)&&!_.isEmpty(probe.events)&&(probe.events=[probe.events]),!_.isArray(probe.events)||0===probe.events.length)throw new TypeError("A probe must define events");started&&collectEvent(probe)}return probes.push(probe),this},getQueue:function(){return getStorage().then(function(storage){return storage.getItem("queue")})},getProbes:function(){return probes},push:function(entry){getStorage().then(function(storage){writing=writing.then(function(){return queue.push(entry),immutableQueue.push(entry),storage.setItem("queue",queue)})})
},flush:function(){return new Promise(function(resolve){getStorage().then(function(storage){writing=writing.then(function(){return storage.getItem("queue").then(function(flushed){return queue=[],storage.setItem("queue",queue).then(function(){resolve(flushed)})})})})})},start:function(){return getStorage().then(function(storage){return storage.getItem("queue").then(function(savedQueue){_.isArray(savedQueue)&&(immutableQueue=queue=savedQueue),_.forEach(probes,collectEvent),started=!0})})},stop:function(){return started=!1,_.forEach(probes,function(probe){var eventNs=".probe-"+probe.name,removeHandler=function(eventName){runner.off(eventName+eventNs)}
;_.forEach(probe.startEvents,removeHandler),_.forEach(probe.stopEvents,removeHandler),_.forEach(probe.events,removeHandler)}),queue=[],immutableQueue=[],getStorage().then(function(storage){return storage.removeItem("queue").then(resetStorage)})}}}}),define("taoTests/runner/proxy",["lodash","async","core/delegator","core/eventifier","core/promise","core/providerRegistry","core/tokenHandler","core/connectivity"],function(_,async,delegator,eventifier,Promise,providerRegistry,tokenHandlerFactory,connectivity){"use strict";var _defaults={},_slice=[].slice;return providerRegistry(function proxyFactory(proxyName,config){var proxy,delegateProxy,communicator,
communicatorPromise,testDataHolder,extraCallParams={},proxyAdapter=proxyFactory.getProvider(proxyName),initConfig=_.defaults(config||{},_defaults),tokenHandler=tokenHandlerFactory(),middlewares={},initialized=!1,onlineStatus=connectivity.isOnline();function getParams(params){var mergedParams=_.merge({},params,extraCallParams);return extraCallParams={},mergedParams}function applyMiddlewares(request,response){var list=_.map(function(queue){var list=middlewares[queue]||[];return middlewares.all&&(list=list.concat(middlewares.all)),list}(request.command),function(middleware){return function(next){middleware(request,response,next)}});return new Promise(function(
resolve,reject){async.series(list,function(err){err||"error"!==response.status||(err=response.data),err?reject(err):(proxy.trigger("receive",response.data,"proxy"),resolve(response.data))})})}function delegate(fnName){var request={command:fnName,params:_slice.call(arguments,1)};return initialized||_.contains(["install","init"],fnName)?delegateProxy.apply(null,arguments).then(function(data){return initialized=!0,applyMiddlewares(request,{status:"success",data:data})}).catch(function(data){return applyMiddlewares(request,{status:"error",data:data})}):Promise.reject(new Error("Proxy is not properly initialized or has been destroyed!"))}return proxy=eventifier({
use:function(command){var queue=command&&_.isString(command)?command:"all",list=middlewares[queue]||[];return middlewares[queue]=list,_.each(arguments,function(cb){_.isFunction(cb)&&list.push(cb)}),this},install:function(dataHolder){return dataHolder&&(testDataHolder=dataHolder),delegate("install",initConfig)},init:function(params){return delegate("init",initConfig,getParams(params))},destroy:function(){return delegate("destroy").then(function(){if(initialized=!1,communicatorPromise)return new Promise(function(resolve,reject){function destroyCommunicator(){communicator.destroy().then(resolve).catch(reject)}communicatorPromise.then(function(){
destroyCommunicator()}).catch(function(){communicator?destroyCommunicator():resolve()})})})},getDataHolder:function(){return testDataHolder},setOnline:function(){return this.isOffline()&&(onlineStatus=!0,this.trigger("reconnect")),this},setOffline:function(source){return this.isOnline()&&(onlineStatus=!1,this.trigger("disconnect",source)),this},isOnline:function(){return onlineStatus},isOffline:function(){return!onlineStatus},isConnectivityError:function(err){return _.isObject(err)&&"network"===err.source&&0===err.code&&!1===err.sent},getTokenHandler:function(){return tokenHandler},hasCommunicator:function(){return!!communicatorPromise},
getCommunicator:function(){var self=this;return initialized?(communicatorPromise||(communicatorPromise=new Promise(function(resolve,reject){_.isFunction(proxyAdapter.loadCommunicator)?(communicator=proxyAdapter.loadCommunicator.call(self))?communicator.before("error",function(e,err){self.isConnectivityError(err)&&self.setOffline("communicator")}).on("error",function(err){self.trigger("error",err)}).on("receive",function(response){self.setOnline(),self.trigger("receive",response,"communicator")}).init().then(function(){return communicator.open().then(function(){resolve(communicator)}).catch(reject)}).catch(reject):reject(new Error(
"No communicator has been set up!")):reject(new Error("The proxy provider does not have a loadCommunicator method"))})),communicatorPromise):Promise.reject(new Error("Proxy is not properly initialized or has been destroyed!"))},channel:function(name,handler){if(!_.isString(name)||name.length<=0)throw new TypeError("A channel must have a name");if(!_.isFunction(handler))throw new TypeError("A handler must be attached to a channel");return this.getCommunicator().then(function(communicatorInstance){communicatorInstance.channel(name,handler)}).catch(_.noop),this.on("channel-"+name,handler),this},send:function(channel,message){return this.getCommunicator().then(
function(communicatorInstance){return communicatorInstance.send(channel,message)})},addCallActionParams:function(params){return _.isPlainObject(params)&&_.merge(extraCallParams,params),this},getTestData:function(){return delegate("getTestData")},getTestContext:function(){return delegate("getTestContext")},getTestMap:function(){return delegate("getTestMap")},sendVariables:function(variables,deferred){return delegate("sendVariables",variables,deferred)},callTestAction:function(action,params,deferred){return delegate("callTestAction",action,getParams(params),deferred)},getItem:function(uri,params){return delegate("getItem",uri,params)},submitItem:function(uri,
state,response,params){return delegate("submitItem",uri,state,response,getParams(params))},callItemAction:function(uri,action,params,deferred){return delegate("callItemAction",uri,action,getParams(params),deferred)},telemetry:function(uri,signal,params){return delegate("telemetry",uri,signal,params)}}),connectivity.on("offline",function(){proxy.setOffline("device")}).on("online",function(){proxy.setOnline()}),proxy.on("message",function(channel,message){this.trigger("channel-"+channel,message)}).use(function(request,response,next){response.data&&response.data.messages&&_.forEach(response.data.messages,function(msg){msg.channel?proxy.trigger("message",
msg.channel,msg.message):proxy.trigger("message","malformed",msg)}),next()}).use(function(request,response,next){proxy.isConnectivityError(response.data)?proxy.setOffline("request"):response.data&&!0===response.data.sent&&proxy.setOnline(),next()}),delegateProxy=delegator(proxy,proxyAdapter,{name:"proxy",wrapper:function(response){return Promise.resolve(response)}}),proxy})}),define("taoTests/runner/proxy/sample",["lodash","core/promise"],function(_,Promise){"use strict";return{init:function(config){return new Promise(function(resolve,reject){resolve()})},destroy:function(){return new Promise(function(resolve,reject){resolve()})},getTestData:function(){
return new Promise(function(resolve,reject){resolve()})},getTestContext:function(){return new Promise(function(resolve,reject){resolve()})},callTestAction:function(action,params){return new Promise(function(resolve,reject){resolve()})},getItem:function(uri){return new Promise(function(resolve,reject){resolve()})},submitItem:function(uri,state,response){return new Promise(function(resolve,reject){resolve()})},callItemAction:function(uri,action,params){return new Promise(function(resolve,reject){resolve()})},telemetry:function(uri,signal,params){return new Promise(function(resolve,reject){resolve()})}}}),define("taoTests/runner/runner",["jquery","lodash",
"i18n","core/eventifier","core/promise","core/logger","core/providerRegistry","taoTests/runner/dataHolder"],function($,_,__,eventifier,Promise,logger,providerRegistry,dataHolderFactory){"use strict";return providerRegistry(function testRunnerFactory(providerName,pluginFactories,config){var runner,areaBroker,proxy,probeOverseer,testStore,dataHolder=dataHolderFactory(),plugins={},states={init:!1,ready:!1,render:!1,finish:!1,destroy:!1},itemStates={},provider=testRunnerFactory.getProvider(providerName);function providerRun(method){var args=[].slice.call(arguments,1);return new Promise(function(resolve){return _.isFunction(provider[method])?resolve(
provider[method].apply(runner,args)):resolve()})}function pluginRun(method){var execStack=[];return _.forEach(runner.getPlugins(),function(plugin){_.isFunction(plugin[method])&&execStack.push(plugin[method]())}),Promise.all(execStack)}function reportError(err){runner.trigger("error",err)}return config=config||{},(runner=eventifier({init:function(){var self=this;return _.forEach(pluginFactories,function(pluginFactory){var plugin=pluginFactory(runner,self.getAreaBroker());plugins[plugin.getName()]=plugin}),providerRun("install").then(_.partial(providerRun,"loadPersistentStates")).then(_.partial(pluginRun,"install")).then(_.partial(providerRun,"init")).then(
_.partial(pluginRun,"init")).then(function(){self.setState("init",!0).off("init.internal").after("init.internal",function(){this.render()}).trigger("init")}).catch(reportError),this},render:function(){var self=this;return providerRun("render").then(function(){pluginRun("render").then(function(){self.setState("ready",!0).trigger("render").trigger("ready")}).catch(reportError)}).catch(reportError),this},loadItem:function(itemRef){var self=this;return providerRun("loadItem",itemRef).then(function(itemData){self.setItemState(itemRef,"loaded",!0).off("loaditem.internal").after("loaditem.internal",function(){this.renderItem(itemRef,itemData)}).trigger("loaditem",
...
"disableitem",itemRef)}).catch(reportError),this},enableItem:function(itemRef){var self=this;return this.getItemState(itemRef,"disabled")&&providerRun("enableItem",itemRef).then(function(){self.setItemState(itemRef,"disabled",!1).trigger("enableitem",itemRef)}).catch(reportError),this},finish:function(){var self=this;return providerRun("finish").then(function(){pluginRun("finish").then(function(){self.setState("finish",!0).trigger("finish")}).catch(reportError)}).catch(reportError),this},flush:function(){var self=this;return providerRun("flush").then(function(){pluginRun("flush").then(function(){self.setState("flush",!0).trigger("flush")}).catch(reportError)
}).catch(reportError),this},destroy:function(){var self=this;return providerRun("destroy").then(function(){pluginRun("destroy").then(function(){return(proxy?proxy.destroy():Promise.resolve()).then(function(){self.setTestContext({}).setTestMap({}).setState("destroy",!0).trigger("destroy")})}).catch(reportError)}).catch(reportError),this},getPlugins:function(){return plugins},getPlugin:function(name){return plugins[name]},getConfig:function(){return config},getAreaBroker:function(){return areaBroker||(areaBroker=provider.loadAreaBroker.call(this)),areaBroker},getProxy:function(){var self=this;if(!proxy){if(!_.isFunction(provider.loadProxy))throw new Error(
"The provider does not have a loadProxy method");(proxy=provider.loadProxy.call(this)).on("error",function(error){self.trigger("error",error)}),proxy.install(dataHolder)}return proxy},getProbeOverseer:function(){return!probeOverseer&&_.isFunction(provider.loadProbeOverseer)&&(probeOverseer=provider.loadProbeOverseer.call(this)),probeOverseer},getTestStore:function(){return!testStore&&_.isFunction(provider.loadTestStore)&&(testStore=provider.loadTestStore.call(this)),testStore},getPluginStore:function(name){var loadedStore=this.getTestStore();return loadedStore&&_.isFunction(loadedStore.getStore)?this.getTestStore().getStore(name):Promise.reject(new Error(
"Please configure a testStore via loadTestStore to be able to get a plugin store"))},getState:function(name){return!!states[name]},setState:function(name,active){if(!_.isString(name)||_.isEmpty(name))throw new TypeError("The state must have a name");return states[name]=!!active,this},getPersistentState:function(name){var state;return _.isFunction(provider.getPersistentState)&&(state=provider.getPersistentState.call(runner,name)),!!state},setPersistentState:function(name,active){var stored;return(stored=!_.isString(name)||_.isEmpty(name)?Promise.reject(new TypeError("The state must have a name")):providerRun("setPersistentState",name,!!active)).catch(
reportError),stored},getItemState:function(itemRef,name){if(_.isEmpty(itemRef)||_.isEmpty(name))throw new TypeError("The state is identified by an itemRef and a name");return!(!itemStates[itemRef]||!itemStates[itemRef][name])},setItemState:function(itemRef,name,active){if(_.isEmpty(itemRef)||_.isEmpty(name))throw new TypeError("The state is identified by an itemRef and a name");return itemStates[itemRef]=itemStates[itemRef]||{loaded:!1,ready:!1,disabled:!1},itemStates[itemRef][name]=!!active,this},getTestData:function(){return dataHolder&&dataHolder.get("testData")},setTestData:function(testData){return dataHolder&&_.isPlainObject(testData)&&dataHolder.set(
"testData",testData),this},getTestContext:function(){return dataHolder&&dataHolder.get("testContext")},setTestContext:function(testContext){return dataHolder&&_.isPlainObject(testContext)&&dataHolder.set("testContext",testContext),this},getTestMap:function(){return dataHolder&&dataHolder.get("testMap")},setTestMap:function(testMap){return dataHolder&&_.isPlainObject(testMap)&&dataHolder.set("testMap",testMap),this},getDataHolder:function(){return dataHolder},next:function(scope){return this.trigger("move","next",scope),this},previous:function(scope){return this.trigger("move","previous",scope),this},jump:function(position,scope){return this.trigger("move",
"jump",scope,position),this},skip:function(scope){return this.trigger("skip",scope),this},exit:function(why){return this.trigger("exit",why),this},pause:function(){return this.getState("pause")||this.setState("pause",!0).trigger("pause"),this},resume:function(){return!0===this.getState("pause")&&this.setState("pause",!1).trigger("resume"),this},timeout:function(scope,ref,timer){return this.trigger("timeout",scope,ref,timer),this}})).on("move",function(type){this.trigger.apply(this,[type].concat([].slice.call(arguments,1)))}).after("destroy",function(){dataHolder&&dataHolder.clear(),testStore=probeOverseer=proxy=areaBroker=null}),runner},function(provider){
if(!_.isFunction(provider.loadAreaBroker))throw new TypeError("The runner provider MUST have a method that returns an areaBroker");return!0})}),define("tpl!taoTests/template/runnerComponent",["handlebars"],function(hb){return hb.template(function(Handlebars,depth0,helpers,partials,data){return this.compilerInfo=[4,">= 1.0.0"],helpers=this.merge(helpers,Handlebars.helpers),data=data||{},'<div class="runner-component"></div>\n'})}),define("taoTests/runner/runnerComponent",["jquery","lodash","context","core/promise","core/pluginLoader","core/providerLoader","ui/component","taoTests/runner/runner","tpl!taoTests/template/runnerComponent"],function($,_,context,
Promise,pluginLoaderFactory,providerLoaderFactory,component,runnerFactory,runnerComponentTpl){"use strict";var requiredOptions=["provider"],defaults={};function loadModules(loader,modules){return loader().addList(modules).load(context.bundle)}function registerProviders(providers){return _.forEach(providers,function(provider){runnerFactory.registerProvider(provider.name,provider)}),providers}return function(container,config,template){var runner=null,runnerComponentApi={getOption:function(name){return this.config[name]},getRunner:function(){return runner}};return config=_.omit(_.defaults(config||{},defaults),["renderTo"]),_.forEach(requiredOptions,function(
name){if(void 0===config[name])throw new TypeError("Missing required option "+name)}),component(runnerComponentApi).setTemplate(template||runnerComponentTpl).on("init",function(){var self=this,plugins=[],initPromises=[];self.getOption("providers")&&initPromises.push(loadModules(providerLoaderFactory,self.getOption("providers")).then(registerProviders)),self.getOption("plugins")&&initPromises.push(loadModules(pluginLoaderFactory,self.getOption("plugins")).then(function(loadedPlugins){plugins=loadedPlugins})),Promise.all(initPromises).then(function(){self.on("render.runnerComponent",function(){var runnerConfig=_.assign(_.omit(self.config,["plugins","providers"
]),{renderTo:self.getElement()});self.off("render.runnerComponent"),runner=runnerFactory(runnerConfig.provider,plugins,runnerConfig).on("error",function(err){self.trigger("error",err)}).on("ready",function(){_.defer(function(){self.show().setState("ready").trigger("ready",runner)})}).after("destroy",function(){this.removeAllListeners()}).init()}).render(container).hide()})}).on("destroy",function(){var destroying=runner&&runner.destroy();return runner=null,destroying}).after("destroy",function(){this.removeAllListeners()}).init(config)}}),define("taoTests/runner/testStore",["lodash","core/promise","core/store","core/logger"],function(_,Promise,store,
loggerFactory){"use strict";var logger=loggerFactory("taoQtiTest/runner/provider/testStore"),legacyPrefixes=["actions-","duration-","test-probe","timer-"],modes={unified:"unified",fragmented:"fragmented"};return function(testId,preselectedBackend){var testMode,storeNames=[],volatiles=[],changeTracking={},isStoreModeUnified=function(){return _.isUndefined(testMode)?function(testId,preselectedBackend){return store.getAll(function(storeName){return _.some(legacyPrefixes,function(prefix){return!_.isEmpty(storeName)&&prefix+testId===storeName})},preselectedBackend).then(function(foundStores){return _.isArray(foundStores
)&&0<foundStores.length?modes.fragmented:modes.unified})}(testId,preselectedBackend).then(function(result){return testMode=result&&void 0!==modes[result]?result:modes.unified,logger.debug("Test store mode "+result+" for "+testId),result===modes.unified}):Promise.resolve(testMode===modes.unified)};if(_.isEmpty(testId))throw new TypeError("The store must be identified with a unique test identifier");return{getStore:function(storeName){var trackChange=function(){_.isBoolean(changeTracking[storeName])&&(changeTracking[storeName]=!0)};if(_.isEmpty(storeName))throw new TypeError("A store name must be provided to get the store");return _.contains(storeNames,
storeName)||storeNames.push(storeName),isStoreModeUnified().then(function(isUnified){return store(isUnified?testId:storeName+"-"+testId,preselectedBackend).then(function(loadedStore){var keyPattern=new RegExp("^"+storeName+"__"),storeKey=function(key){return isUnified?storeName+"__"+key:key};return{getItem:function(key){return loadedStore.getItem(storeKey(key))},getItems:function(){return isUnified?loadedStore.getItems().then(function(entries){return _.transform(entries,function(acc,entry,key){return keyPattern.test(key)&&(acc[key.replace(keyPattern,"")]=entry),acc},{})}):loadedStore.getItems()},setItem:function(key,value){return trackChange(),
loadedStore.setItem(storeKey(key),value)},removeItem:function(key){return trackChange(),loadedStore.removeItem(storeKey(key))},clear:function(){return trackChange(),isUnified?loadedStore.getItems().then(function(entries){_.forEach(entries,function(entry,key){keyPattern.test(key)&&loadedStore.removeItem(key)})}):loadedStore.clear()}}})})},setVolatile:function(storeName){return _.contains(volatiles,storeName)||volatiles.push(storeName),this},clearVolatileIfStoreChange:function(storeId){var self=this,shouldClear=!1;return store.getIdentifier(preselectedBackend).then(function(savedStoreId){return _.isEmpty(storeId)||_.isEmpty(savedStoreId
)||savedStoreId===storeId||(logger.info("Storage change detected ("+savedStoreId+" != "+storeId+") => volatiles data wipe out !"),shouldClear=!0),shouldClear}).then(function(clear){return!!clear&&self.clearVolatileStores()})},clearVolatileStores:function(){var self=this,clearing=volatiles.map(function(storeName){return self.getStore(storeName).then(function(storeInstance){return storeInstance.clear()})});return Promise.all(clearing).then(function(results){return results&&results.length===volatiles.length})},startChangeTracking:function(storeName){return changeTracking[storeName]=!1,this},hasChanges:function(storeName){return!0===changeTracking[storeName]},
resetChanges:function(storeName){return _.isBoolean(changeTracking[storeName])&&(changeTracking[storeName]=!1),this},remove:function(){var legacyStoreExp=new RegExp("-"+testId+"$");return isStoreModeUnified().then(function(isUnified){return isUnified?store(testId,preselectedBackend).then(function(storeInstance){return storeInstance.removeStore()}):store.removeAll(function(storeName){return legacyStoreExp.test(storeName)},preselectedBackend)})},getStorageIdentifier:function(){return store.getIdentifier(preselectedBackend)}}}}),define("taoTests/loader/taoTestsRunner.bundle",function(){});
