...
$GLOBALS['__l10n']["An error occurred during user deletion"]="ユーザーの削除中にエラーが発生しました";
...
$GLOBALS['__l10n']["Connect to the TAO platform"]="CBT プラットホームへ接続";
...
$GLOBALS['__l10n']["Please report bugs, ideas, comments or feedback on the TAO Forum"]="TAO Forumにバグ、アイデア、コメントやフィードバックを報告してください";
...
$GLOBALS['__l10n']["Test properties"]="テスト属性";
...
$GLOBALS['__l10n']["The Test mode (sequencing, scoring, cumulating, etc.) and layout are also configured here."]="テストのモード（順序・得点・集積など）およびレイアウトはここでも設定されます。";
$GLOBALS['__l10n']["The Tests module allows to combine a selection of Items to a Test."]="テストモジュールは選択された問題をテストに結合することを許可します";
...
$GLOBALS['__l10n']["User deletion not permitted on a demo instance"]="ユーザ削除はデモインスタンスではできません";
