...
$GLOBALS['__l10n']["A QTI item file is an XML file following the version 2.0 of the QTI standard."]="Un item QTI est un fichier XML suivant la version 2.0 du standard QTI.";
$GLOBALS['__l10n']["A QTI package is a Zip archive containing a imsmanifest.xml file and the QTI resources to import."]="Un package QTI est une archive zippée contenant un fichier imsmanifest.xml et les ressources QTI à importer.";
...
$GLOBALS['__l10n']["add Consumer"]="ajouter consumer";
...
$GLOBALS['__l10n']["Add the source file"]="Fichier source";
...
$GLOBALS['__l10n']["Advanced Mode"]="Mode avancé";
$GLOBALS['__l10n']["Advanced Users"]="Utilisateurs Avancés";
$GLOBALS['__l10n']["All"]="Tout";
$GLOBALS['__l10n']["all"]="tout";
$GLOBALS['__l10n']["All (the complete TAO Module)"]="Tout (le module TAO au complet)";
$GLOBALS['__l10n']["All classes in Design Mode will switch to Production Mode. Please confirm."]="Toutes les classes en mode design vont basculer en mode production. Veuillez confirmer.";
$GLOBALS['__l10n']["All classes in Production Mode will switch to Design Mode. Please confirm."]="Toutes les classes en mode production vont basculer en mode design. Veuillez confirmer.";
...
$GLOBALS['__l10n']["An Open Web Item package is a Zip archive containing an index.html file with the XHTML 1.0 Transitional Doctype and resources (images, scripts, css, video, etc.)."]="Un package Open Web Item est une archive zippée contenant un fichier index.html avec le Doctype XHTML 1.0 Transitional et des ressources (images, scripts, CSS, vidéo, etc.).";
...
$GLOBALS['__l10n']["Available Classes"]="Classes Disponibles";
$GLOBALS['__l10n']["Available Extensions"]="Extensions disponibles";
$GLOBALS['__l10n']["Available Items"]="Items disponibles";
...
$GLOBALS['__l10n']["Check pending tasks for assessment preparation."]="Consultez les tâches en attente pour la préparation de l'évaluation.";
...
$GLOBALS['__l10n']["Create items, manage item and test banks, organize cohorts and deliveries, prepare reports, set up workflows."]="Créez des items, gérez des banques d'items et de tests, organisez des groupes et des passations, préparez des rapports, mettez en place des workflows.";
$GLOBALS['__l10n']["Create new tests or items, register test takers or watch results..."]="Créez de nouveaux tests ou items, enregistrez des test takers ou regarder les résultats...";
$GLOBALS['__l10n']["CSV"]="CSV";
$GLOBALS['__l10n']["CSV Options"]="Options CSV";
$GLOBALS['__l10n']["Current"]="Courant";
$GLOBALS['__l10n']["Current (the current extension, the local data and their dependancies)"]="Courant (l'extension courante, les données locales et leurs dépendances)";
...
$GLOBALS['__l10n']["Delivery of result"]="Passation du résultat";
...
$GLOBALS['__l10n']["Disable validation"]="Désactiver la validation";
...
$GLOBALS['__l10n']["Drag and drop the items to order them"]="Glissez/déposez les items pour les ordonner.";
...
$GLOBALS['__l10n']["Edit test class"]="Modifier la classe du test";
...
$GLOBALS['__l10n']["Enables you to export an RDF file containing the selected namespaces or instances"]="Ce format vous permet d'exporter un fichier RDF contenant les espaces de noms sélectionnés ou des instances.";
...
$GLOBALS['__l10n']["Execute workflows for assessment preparation."]="Exécutez des workflows pour préparer l'évaluation.";
...
$GLOBALS['__l10n']["Items sequence"]="Séquence des items";
...
$GLOBALS['__l10n']["Login here to take a test."]="Connectez-vous ici pour passer un test.";
$GLOBALS['__l10n']["Login to the TAO Back Office"]="Se connecter au Back Office TAO.";
$GLOBALS['__l10n']["Logout"]="Déconnexion";
$GLOBALS['__l10n']["Mail"]="Courriel";
$GLOBALS['__l10n']["make sure to back up your data before changing modes."]="assurez-vous d'avoir sauvegardé vos données avant de changer de mode.";
...
$GLOBALS['__l10n']["Manage deliveries"]="Gestion des passations";
...
$GLOBALS['__l10n']["Media Management"]="Gestion des médias";
...
$GLOBALS['__l10n']["Minutes"]="minute(s)";
...
$GLOBALS['__l10n']["new item"]="Créer item";
...
$GLOBALS['__l10n']["Please upload a CSV file formated as defined by the options above."]="Veuillez téléverser un fichier au format CSV (défini par les options ci-dessous).";
...
$GLOBALS['__l10n']["Production Mode:"]="Mode production :";
...
$GLOBALS['__l10n']["Repeat new password"]="Répéter le nouveau mot de passe";
...
$GLOBALS['__l10n']["Repository Type"]="Type de dépôt";
...
$GLOBALS['__l10n']["Result Servers library"]="Bibliothèque de serveurs de résultats";
...
$GLOBALS['__l10n']["Seconds"]="seconde(s)";
...
$GLOBALS['__l10n']["Select the items composing the test."]="Sélectionnez les items qui composent le test.";
...
$GLOBALS['__l10n']["Sequence saved successfully"]="La séquence a été enregistrée avec succès.";
...
$GLOBALS['__l10n']["suitable for data modeling (default mode)."]="adapté à la modélisation de données (mode par défaut).";
...
$GLOBALS['__l10n']["TAO Delivery Server"]="Serveur de passation de test TAO";
...
$GLOBALS['__l10n']["TAO WorkFlow Assistant"]="Assistant du workflow TAO";
$GLOBALS['__l10n']["TAO workflow engine"]="Workflow engine TAO";
$GLOBALS['__l10n']["Test Developers and Administrators"]="Développeurs et administrateurs de tests";
$GLOBALS['__l10n']["Test properties"]="Propriétés du test";
$GLOBALS['__l10n']["Test saved"]="Test enregistré";
$GLOBALS['__l10n']["Test taker of result"]="Participant du résultat";
...
$GLOBALS['__l10n']["Upload a QTI Package File"]="Téléverser un fichier package QTI";
$GLOBALS['__l10n']["Upload an Open Web Item Package File"]="Téléverser un fichier package Open Web Item";
$GLOBALS['__l10n']["Upload CSV File"]="Téléverser le fichier CSV";
$GLOBALS['__l10n']["Upload File"]="Téléverser le fichier";
$GLOBALS['__l10n']["Upload QTI File"]="Téléverser fichier QTI";
$GLOBALS['__l10n']["Upload RDF File"]="Téléverser un fichier RDF";
