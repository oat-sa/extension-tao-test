...
$GLOBALS['__l10n']["Delete this list"]="Supprimer cette liste";
...
$GLOBALS['__l10n']["Disabled %s', \$this->getRequestParameter('id"]="%s', désactivé, \$ceci->donnerlesparamètresàlademande('id";
...
$GLOBALS['__l10n']["Edit this list"]="Modifier cette liste";
$GLOBALS['__l10n']["Element"]="Élément";
$GLOBALS['__l10n']["element"]="élément";
$GLOBALS['__l10n']["Element deleted"]="Élément supprimé";
$GLOBALS['__l10n']["Element deleted."]="Élément supprimé.";
$GLOBALS['__l10n']["Element not deleted"]="Élément non supprimé";
$GLOBALS['__l10n']["Email"]="Email";
$GLOBALS['__l10n']["Enter"]="Entrée";
$GLOBALS['__l10n']["Entity with such field already present"]="Une entité avec un même champ existe déjà";
...
$GLOBALS['__l10n']["List not deleted"]="Liste non supprimée";
$GLOBALS['__l10n']["List not saved"]="Liste non enregistré";
...
$GLOBALS['__l10n']["New repository"]="Nouveau répoertoire";
...
$GLOBALS['__l10n']["Please confirm you want to delete this list. This operation cannot be undone."]="Veuillez confirmer que vous voulez supprimer cette liste. Cette opération ne peut pas être annulée.";
$GLOBALS['__l10n']["Please contact %s or an administrator to release it', get_data('ownerHtml"]="Veuillez contacter %s ou un administrateur pour le' publier, données_obtenues('ownerHtml";
...
$GLOBALS['__l10n']["Please select alteast one namespace"]="Veuillez sélectionner au moins un espace de nommage";
...
$GLOBALS['__l10n']["Releasing the lock might cause the work in progress by %s to be lost.', get_data('ownerHtml"]="Publier la serrure pourrait causer une perte du travail en cours par %s , données_obtenues('ownerHtml";
...
$GLOBALS['__l10n']["Supported import formats"]="Formats de fichiers pris en charge";
...
$GLOBALS['__l10n']["Tao Home"]="La maison de TAO";
...
$GLOBALS['__l10n']["This %s is currently checked out', get_data('topclass-label"]="Ce %s est en cours de vérification, données_obtenues('catégorie-étiquette";
...
$GLOBALS['__l10n']["Unable to delete the selected class"]="Impossible de supprimer les classes sélectionnées";
...
$GLOBALS['__l10n']["Uninstall of %s failed', \$this->getRequestParameter('id"]="Désinstallation de %s raté, \$ceci>paramètresrequisobtenus('id";
$GLOBALS['__l10n']["Uninstalled %s', \$this->getRequestParameter('id"]="Désinstallation %s', \$ceci->paramètrerequisobtenu('id";
$GLOBALS['__l10n']["unknown"]="inconnu";
$GLOBALS['__l10n']["Unknown Error"]="Erreur Inconnue";
$GLOBALS['__l10n']["Unselect all"]="Désélectionner tout";
...
$GLOBALS['__l10n']["You can use * as a wildcard"]="Vous pouvez utiliser * comme un joker";
...
$GLOBALS['__l10n']["You've not the required rights to edit this resource."]="Vous n'avez pas les droits requis pour éditer cette ressource.";
